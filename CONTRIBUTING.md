...
Report bugs at https://github.com/lavvr/etl/issues.
...
ETL could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/lavvr/etl/issues.
...
Ready to contribute? Here's how to set up `etl` for local development.

1. Fork the `etl` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/etl.git
   ```
